...
- [Yojoies Development Document (Front-end developer)](#yojoies-development-document-front-end-developer)
  - [Model Structure Project](#model-structure-project)
...
// สเตตัสโค๊ด จากหลังบ้าน
    var statusCodesArr = {
        ...
        "4023": { "en": "Existed This phone number has already been registered.", "zh": "手机号已经存在", "th": "มีหมายเลขโทรศัพท์มือถือแล้ว" },
        ...
        "4047": { "en": "Product state is invalid", "zh": "menu_home状态无效", "th": "สถานะผลิตภัณฑ์ไม่ถูกต้อง" },
